    ...
    <div ref={scrollerRef} className="relative bg-[#05060A] text-white">
      ...
      <nav
        className={`fixed top-0 left-0 right-0 z-40 transition-all duration-500 ${
          scrolled
            ? "backdrop-blur-xl bg-[#05060A]/60 border-b border-white/5"
            : "bg-transparent"
        }`}
      >
      ...
      >
        ...
        <p className="relative mt-8 max-w-2xl text-lg text-white/70 leading-relaxed">
          NeevAI transforms ordinary smartphones into clinical-grade diagnostic
          tools for India's 1M+ frontline ASHA workers — fully offline, fully
          private, fully theirs.
        </p>
          ...
          >
            ...
            >
              <div className="backdrop-blur-2xl bg-white/[0.03] border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl">
                <p className="text-xs uppercase tracking-[0.25em] text-[#00E5FF] mb-5">
                  {z.tag}
                </p>
      ...
      <section
        id="tech"
        className="relative z-10 py-32 px-6 md:px-16 border-t border-white/5"
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-20 grid md:grid-cols-3 gap-6">
            {[
              ...
              >
                <div className="text-xs uppercase tracking-widest text-[#FFB547]">
                  Modality
                </div>
      ...
      >
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-xs uppercase tracking-[0.3em] text-[#FFB547] mb-4">
            Field-tested
          </p>
          ...
          <p className="mt-8 text-lg text-white/70 max-w-2xl mx-auto leading-relaxed">
            ...
            <span className="text-white">2,300+ ASHA workers</span>. Early
            results: 4× more TB referrals, 60% drop in unnecessary travel, 92%
            worker satisfaction.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="rounded-[2rem] p-10 md:p-16 bg-gradient-to-br from-[#00E5FF]/10 via-[#00FFA3]/5 to-transparent border border-[#00FFA3]/20 backdrop-blur-xl">
            ...
            <p className="mt-6 text-white/70 max-w-xl leading-relaxed">
              We're partnering with state governments, NGOs, hospital networks,
              and researchers. If you serve communities the system forgot — we
            ...
            >
              <input
                ...
                className="flex-1 px-5 py-4 rounded-full bg-white/5 border border-white/10 text-white placeholder:text-white/40 focus:outline-none focus:border-[#00FFA3] transition"
              />
              <button
                type="submit"
                className="px-7 py-4 rounded-full bg-[#00FFA3] text-[#05060A] font-semibold hover:scale-105 transition-transform"
              >
                Request a pilot
              </button>
            </form>
